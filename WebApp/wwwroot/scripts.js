    ...
    var populateConfigurationTable = function(data) {
        ...
        for (i = 0, len = counters.length, text = ""; i < len; i++) {
            var $form = $("<form class=\"configurationCounterDetails\">\n" +
                "                                    <div class=\"form-row\">\n" +
                "                                        <div class=\"col\">\n" +
                "                                            <input id=\"number\" name=\"number\" type=\"number\" class=\"form-control\" placeholder=\"Number\" value=\"" +
                counters[i].id +
                "\">\n" +
                "                                        </div>\n" +
                "                                        <div class=\"col\">\n" +
        ...
        for (i = 0, len = openTimes.length, text = ""; i < len; i++) {
            var $form = $("<form class=\"configurationOpenTimes\">\n" +
                "                                    <div class=\"form-row\">\n" +
                "                                        <div class=\"col\">\n" +
                "                                            <input id=\"day\" name=\"day\" type=\"text\" class=\"form-control\" placeholder=\"Day\" value=\"" +
                openTimes[i].day +
                "\">\n" +
                "                                        </div>\n" +
                "                                        <div class=\"col\">\n" +
                "                                            <input id=\"from\" name=\"from\" type=\"text\" class=\"form-control\" placeholder=\"From\" value=\"" +
                openTimes[i].beginTimestamp +
                "\">\n" +
                "                                        </div>\n" +
                "                                        <div class=\"col\">\n" +
                "                                            <input id=\"to\" name=\"to\" type=\"text\" class=\"form-control\" placeholder=\"To\" value=\"" +
                openTimes[i].endTimestamp +
                "\">\n" +
                "                                        </div>\n" +
                "                                    </div>\n" +
                "                                </form>");
