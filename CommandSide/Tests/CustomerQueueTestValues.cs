...
namespace Tests
{
    public static class CustomerQueueTestValues
    {
        ...
        public static readonly CustomerTaken CustomerWithTicket1_Taken = new CustomerTaken(SingleCustomerQueueId, CounterA_Id, Ticket1_Id, Ticket1_TakenTimestamp);
        ...
        public static readonly CustomerRevoked CustomerWithTicket1_Revoked = new CustomerRevoked(SingleCustomerQueueId, CounterA_Id, Ticket1_Id);
    }
}