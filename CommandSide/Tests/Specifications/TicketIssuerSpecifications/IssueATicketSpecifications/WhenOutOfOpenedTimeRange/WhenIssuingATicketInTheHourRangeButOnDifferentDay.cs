...
{
    public sealed class WhenIssuingATicketInTheHourRangeButOnDifferentDay : TicketIssuerSpecification<IssueATicket>
    {
        public WhenIssuingATicketInTheHourRangeButOnDifferentDay() : base(SingleTicketIssuerId)
        {
        }
        ...
        public override IEnumerable<TicketIssuerEvent> Given()
        {
            ...
            yield return Tuesday9To12Added;
        }
