...
{
    public sealed class WhenCustomerHasAlreadyBeenReCalled : CustomerQueueSpecification<ReCallCustomer>
    {
        public WhenCustomerHasAlreadyBeenReCalled() : base(SingleCustomerQueueId)
        {
        }
        ...
        public override IEnumerable<CustomerQueueEvent> Given()
        {
            ...
            yield return Customer1RecalledByCounter(Counter1Id);
        }
        ...
        [Fact]
        public void Customer1_has_been_recalled_again() => ProducedEvents.Should().Contain(Customer1RecalledByCounter(Counter1Id));
    }
}