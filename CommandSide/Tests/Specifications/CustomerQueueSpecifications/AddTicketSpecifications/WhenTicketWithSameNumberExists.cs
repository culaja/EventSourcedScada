...
namespace CommandSide.Tests.Specifications.CustomerQueueSpecifications.AddTicketSpecifications
{
    ...
    {
        public WhenTicketWithSameNumberExists() : base(CustomerQueueTestValues.SingleCustomerQueueId)
        {
        }
        
        protected override AddTicket CommandToExecute => new AddTicket(CustomerQueueTestValues.Ticket2_Id, CustomerQueueTestValues.Ticket1_Number);
